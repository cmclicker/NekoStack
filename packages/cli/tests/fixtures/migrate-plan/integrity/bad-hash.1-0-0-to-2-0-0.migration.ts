/**
 * `fromIrHash` is not a valid 64-hex sha256 →
 * `parseMigrationProvenanceFromText` returns `integrity_error` with
 * `metadata.reason: "malformed_hash"`. The command exits INTEGRITY_ERROR.
 *
...
const migration: Migration<"com.fixture.cli.migrate-plan.Integrity", "1.0.0", "2.0.0"> = {
  schemaId: "com.fixture.cli.migrate-plan.Integrity",
  from: "1.0.0",
  to: "2.0.0",
  transform(input) {
